...
reg.main = (bot, msg) => {
	...
	if (aArg.length >= 4) {
	    ...
	    mChars[dChar] = rChar;
	    fs.writeFileSync("../ressources/ryzomapi/Char_Map.json", JSON.stringify(mChars), "utf8");
	    cKeys[rChar] = cKey;
	    fs.writeFileSync("../ressources/ryzomapi/Char_Keys.json", JSON.stringify(cKeys), "utf8");
